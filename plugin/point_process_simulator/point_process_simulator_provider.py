...
from .point_process_simulator_algorithm import PointProcessSimulatorAlgorithm


class PointProcessSimulatorProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(PointProcessSimulatorAlgorithm())
    ...
    def name(self):
        ...
        """
        return self.tr('PP_EstAndSim_provider')
